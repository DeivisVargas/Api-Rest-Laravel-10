...
@section('content')
    <form method="POST" action="{{route('produto.cadastrar')}}">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Cadastro novo Produto</h1>
        </div>
        <div class="row mt-5">
            <div class="col">
            ...
            <div class="col">
                ...
                <input type="text" id="valor" name="valor" class="form-control @error('valor') is-invalid @enderror" aria-label="Valor" value="{{@old('valor')}}">
                @if($errors->has('valor'))
