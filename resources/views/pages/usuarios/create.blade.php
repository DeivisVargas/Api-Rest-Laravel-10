...
@section('content')
    <form method="POST" action="{{route('usuario.cadastrar')}}">
        ...
        <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 class="h2">Cadastro novo Usuário</h1>
        </div>
        <div class="row mt-5">
            <div class="col">
                ...
                --}}
                <input  type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror" aria-label="Nome" value="{{@old('name')}}">
                @if($errors->has('name'))
            ...
            <div class="col">
                ...
                <input type="text" id="email" name="email" class="form-control @error('email') is-invalid @enderror" aria-label="Valor" value="{{@old('email')}}">
                @if($errors->has('email'))
        ...
        <div class="row mt-2">
            <div class="col">
                ...
                <input type="password" id="password" name="password" class="form-control @error('password') is-invalid @enderror" aria-label="Valor" value="{{@old('password')}}">
